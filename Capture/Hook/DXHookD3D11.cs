...
namespace Direct3DHookLib.Hook
{
    ...
    internal class DXHookD3D11 : BaseDXHook
    {
        ...
        public override void Hook()
        {
            ...
            if (_d3d11VTblAddresses == null)
            {
                ...
                if (_device != null && _swapChain != null)
                {
                    ...
                    _dxgiSwapChainVTblAddresses.AddRange(GetVTblAddresses(_swapChain.NativePointer,
        ...
        private delegate int DXGISwapChain_PresentDelegate(
            IntPtr swapChainPtr, int syncInterval, /* int */ PresentFlags flags);
        ...
        /// <returns></returns>
        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        private delegate int DXGISwapChain_ResizeTargetDelegate(
        ...
        private ShaderResourceView _resolvedSharedSRV;
