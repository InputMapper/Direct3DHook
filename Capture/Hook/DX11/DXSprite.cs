...
technique11 SpriteTech {
    pass P0 {
        ...
        {
            var Vec = new Vector4(color.R > 0 ? color.R/255.0f : 0.0f, color.G > 0 ? color.G/255.0f : 0.0f,
                color.B > 0 ? color.B/255.0f : 0.0f, color.A > 0 ? color.A/255.0f : 0.0f);
        ...
        public void Draw(Rectangle destinationRect, Rectangle sourceRect, Color4 color, float scale = 1.0f,
            float angle = 0f, float z = 0f)
        {
